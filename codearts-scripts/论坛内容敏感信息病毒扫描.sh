...
python3  /opt/cached_resources/discource/discourse_scanner.py ${runtimestamp} "https://openubmc-discourse.test.osinfra.cn/posts.json" "openubmc-discourse.test"
pwd

tar -cvf ${runtimestamp}.tar -C /opt/cached_resources/discourse/openubmc-discourse.test/${runtimestamp}/attachments .
ls -l
# 获取 fetch 的仓库地址
...
freshclam
/usr/local/bin/clamscan ${runtimestamp}.tar
